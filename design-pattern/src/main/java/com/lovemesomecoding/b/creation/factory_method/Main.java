...
public class Main {
	public static void main(String[] args) {
		...
		van.reverse();
		System.out
				.println("Lession learned: I must know what class to use. I am not using new keyword which is a good thing.\n");
		System.out
				.println("I also learned about ENUM: 'An enum type is a special data type that enables \n"
